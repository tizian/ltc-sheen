...
def main():
    ...
    def eval_brdf(mu_idx, alpha_idx):
        ...
        # Create the BRDF. Note that the analytic sheen approximation is designed
    ...
    outname = "data/ltc_table_sheen_approx"
    ...
    with open("{}.cpp".format(outname), "w") as f:
        ...
        print("const Vector3f SheenLTC::_ltcParamTableApprox[32][32] = {", file=f)
        idx = 0
